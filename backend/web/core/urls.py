...
urlpatterns = [
    ...
    #path('musicgenre/list', views.music_list_view(), name="musicgenre_list"),
    #path('musicgenre/<str:slug>', views),
    #path('artgenre/list', views.artgenre_list_list_view(), name="artgenre_list"),
    #path('artgenre/<str:slug>', views),
